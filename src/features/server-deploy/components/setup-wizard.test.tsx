...
import { ProviderSelect } from '@/features/server-deploy/components/wizard-steps/ProviderSelect.tsx';
import { AuthProject } from '@/features/server-deploy/components/wizard-steps/AuthProject.tsx';
import { RegionSelect } from '@/features/server-deploy/components/wizard-steps/RegionSelect.tsx';
import { InstanceSelect } from '@/features/server-deploy/components/wizard-steps/InstanceSelect.tsx';
import { DeployConfirm } from '@/features/server-deploy/components/wizard-steps/DeployConfirm.tsx';
...
import type { UiStore } from '@/shared/infra/ui-store.ts';
import { GCP_MACHINE_CATALOG } from '@/shared/infra/entities/index.ts';
import type { RegionLatency, GameBranch } from '@/shared/infra/entities/index.ts';
