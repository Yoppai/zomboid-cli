import type { ICloudProvider, ProvisionRequest } from '@/shared/infra/contracts/i-cloud-provider.ts';
...
import { generateCloudInit } from '@/shared/templates/cloud-init.ts';
import { generateDockerCompose } from '@/shared/templates/docker-compose.ts';
import { calculateServerMemory, findMachineType } from '@/shared/infra/entities/machine-catalog.ts';
