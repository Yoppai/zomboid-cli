...
import type { SshConnectionConfig, PlayerInfo } from '@/shared/infra/entities/value-objects.ts';
...
export class RconService {
  ...
  async getOnlinePlayers(host: string, password: string): Promise<readonly PlayerInfo[]> {
    await this.rcon.connect(host, 27015, password);
    try {
