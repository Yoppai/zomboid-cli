...
import { ServerStats } from '@/presentation/views/dashboard-tabs/ServerStats.tsx';
import { BasicSettings } from '@/presentation/views/dashboard-tabs/BasicSettings.tsx';
import { AdvancedSettings } from '@/presentation/views/dashboard-tabs/AdvancedSettings.tsx';
import { AdminSettings } from '@/presentation/views/dashboard-tabs/AdminSettings.tsx';
import { SchedulerPanel } from '@/presentation/views/dashboard-tabs/SchedulerPanel.tsx';
import { BackupsPanel } from '@/presentation/views/dashboard-tabs/BackupsPanel.tsx';
import { ServiceProvider } from '@/presentation/hooks/use-services.tsx';

let lastOnSelect: any = null;
vi.mock('@/presentation/components/FilePickerButton.tsx', () => ({
