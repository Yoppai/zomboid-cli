...
import { LatencyBar } from '@/presentation/components/LatencyBar.tsx';
import { LogViewer } from '@/presentation/components/LogViewer.tsx';
import { FilePickerButton } from '@/presentation/components/FilePickerButton.tsx';
...
describe('FilePickerButton', () => {
  ...
  it('should show selected filename when provided', () => {
    ...
    expect(lastFrame()).toContain('config.ini');
  });
  ...
  it('should show different selected filename', () => {
    ...
    expect(lastFrame()).toContain('settings.lua');
  });
});
