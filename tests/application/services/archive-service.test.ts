...
import type { ICloudProvider, DestroyResult } from '@/domain/repositories/i-cloud-provider.ts';
...
import type { BackupMeta } from '@/domain/entities/value-objects.ts';
import { createServerId } from '@/domain/entities/enums.ts';
import { CdktfDestroyError } from '@/domain/entities/errors.ts';
