...
import type { ServerRecord } from '../../../src/domain/entities/server-record.ts';
import type { ScheduledTask } from '../../../src/domain/entities/scheduled-task.ts';
import type { Setting, SettingKey } from '../../../src/domain/entities/setting.ts';
import { isValidStatusTransition } from '../../../src/domain/entities/server-record.ts';
import { createServerId, createTaskId } from '../../../src/domain/entities/enums.ts';
import type { ServerStatus } from '../../../src/domain/entities/enums.ts';
