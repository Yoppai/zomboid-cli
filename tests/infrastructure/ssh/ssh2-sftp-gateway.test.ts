...
import { SftpTransferError } from '../../../src/domain/entities/errors.ts';
import type { TransferProgress } from '../../../src/domain/repositories/i-sftp-gateway.ts';

// Production code that does NOT exist yet — guarantees RED
import { Ssh2SftpGateway } from '../../../src/infrastructure/ssh/ssh2-sftp-gateway.ts';
